...
# image sliders:
slider1:
- url: https://raw.githubusercontent.com/RCmags/HeliFlightController/refs/heads/main/images/side_view.JPG
- url: https://raw.githubusercontent.com/RCmags/HeliFlightController/refs/heads/main/images/arduino_view.JPG
- url: /img/heli_controller/main_rotor.JPG
- url: /img/heli_controller/tail_rotor.JPG
...
{% include image.html src="/img/heli_controller/HillerHead500pics.gif" label="Figure.1" text="Bell-Hiller mixing" %}
...
{% include youtube.html id='1fi3qSU-d1o' label="Video.1" text="Lag in stabilizer bar motion" %}   

For helicopters with more than two blades, the bar transforms into a star-shaped object or a ring. 

{% include image.html src="/img/heli_controller/lok_xh-51.gif" label="Figure.2" text="Rod shaped Stabilizer bar" %}
[See: Lockheed XH-51](https://www.aviastar.org/helicopters_eng/lok_xh-51.php)


{% include image.html src="/img/heli_controller/lok_cl-475.gif" label="Figure.3" text="Ring-shaped Stabilizer bar" %}
...
{% include image.html src="/img/heli_controller/pid-response.jpg" label="Figure.4" text="Components of a PID controller" %}
...
{% include youtube.html id='z77q4AkcPiY' label="Video.2" text="Helcopter with Passive stability with tip-weights" %} 

{% include image.html src="/img/heli_controller/heli-v1-nostab.JPG" label="Figure.5" text="Initial airframe with heavy tip weights" %}
...
{% include image.html src="/img/heli_controller/cascade-response.png" label="Figure.6" text="Effect of cascading lower-order filters" %}
...
{% include youtube.html id='qZ7qUPAXkvc' label="Video.3" text="Cascaded 1rst order filters" %}

{% include image.html src="/img/heli_controller/heli-v2-wires.JPG" label="Figure.7" text="Helicopter with Arduino nano and MPU-6050 gyro" %}
...
{% include image.html src="/img/heli_controller/filter-step-response.png" label="Figure.8" text="Step response of a n-order filter" %}
...
{% include youtube.html id='zrrgVdPAhFI' label="Video.4" text="Infinite Impulse Reponse filter" %} 
...
{% include youtube.html id='nHYoC72DZKo' label="Video.5" text="Inbuilt low-pass filter" %} 

{% include image-slider.html list=page.slider1 label="Figure.9" text="Third version of the helicopter along with improved flight controller" %}
...
{% include image.html src="https://raw.githubusercontent.com/RCmags/HeliFlightController/refs/heads/main/images/diagram/schematic.png" label="Figure.10" text="Flight controller schematic" %}
