...
{% include youtube.html id='_25H9ZPE2So' label="Video.1" text="Demonstration of Autorotation" %}
...
{% include image.html src="/img/autogyro/airflow-types.jpg" maxwidth="400px" label="Figure.1" text="Types of lift mechanisms" %}
...
{% include image-slider.html list=page.slider1 label="Figure.6" text="Hinge offset under disturbance"%}
...
{% include image.html src="/img/autogyro/wheel-positions.png" label="Figure.7" text="Landing Gear Configurations" %}
...
{% include image-slider.html list=page.slider2 label="Figure.8" text="Lateral views of the Autogyro" %}

{% include image-slider.html list=page.slider3 label="Figure.9" text="Rotor head: hinge with spring and later leaf spring" %}

{% include youtube.html id='ps-KYJPquqs' text="Flight of 1rst iteration" label="Video.2" %}
...
{% include youtube.html id='RCiWSCi7bfk' label="Video.3" text="Explanation of powered-push-over" %} 
...
{% include image-slider.html list=page.slider4 text="Lateral views of the tailless Autogyro" label="Figure.10" %}

{% include youtube.html id='b1p8pCHiuWo' label="Video.4" text="Flight of 2nd iteration" %} 
